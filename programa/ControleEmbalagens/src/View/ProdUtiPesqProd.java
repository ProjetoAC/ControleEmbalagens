...
public class ProdUtiPesqProd extends javax.swing.JInternalFrame {
    ...
    private void selecionaDadosTabela() {
        ...
        enviaDados.dadosPesquisProduto(a, b, c, d);
        this.dispose();
    }
}
